<?php 
interface svg_graphics
{
  //to draw the x and y axes
    function draw_axes($dimension);
  //to draw user_requested function  
    function draw_func($func);
   
}

class svg_graph implements svg_graphics
{
   ...
   //drwaing axes function
    ...
    public function draw_func($func,$step = 1)
    {
       ...
       //secondly wr doing negative - side of graphic
       ...
       //retuening fully prepared graph
       return $graph;
    }
   ...
   //rendering graph
    public function render_graph($vertexs=null)
    {
        //svg head
